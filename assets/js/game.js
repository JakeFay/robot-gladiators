...
var fight = function(enemy) {
    while (playerInfo.health > 0 && enemy.health > 0) {
        ...
        // if player choses "skip" confirm and then stop the loop 
        ...
        // remove player's health by subtracting the ammount set...
...
var startGame = function() {
    ...
    for (var i = 0; i < enemyInfo.length; i++) {
        ...
        if (playerInfo.health > 0) {
            ...
            // pick new enemy fight based on the index of the enemy.names array
